...
class DatabaseMetadata
  ...
  class << self
    def lookup(connection, database_config)
      result = load_columns(connection, database_config)
      load_stats(result, connection, database_config)
    ...
    def load_columns(connection, database_config)
      result = {}
    ...
    def load_stats(result, connection, database_config)
      database = database_config.client_params[:database]
